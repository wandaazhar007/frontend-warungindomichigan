        ...
        <div className={styles.navContent}>
          ...
          <div className={styles.navActions}>
            ...
            {user ? (
              ...
              <>
                {/* --- THIS IS THE KEY CHANGE --- */}
                {/* The user's name is now a link to their account page */}
                <Link href="/account" className={`${styles.userName} ${styles.desktopOnly}`}>
      ...
      <div className={`${styles.mobileMenu} ${isMenuOpen ? styles.isOpen : ''}`}>
        ...
        {user ? (
          <>
            ...
            <Link href="/account" onClick={toggleMenu}>My Account</Link>
            <button onClick={handleLogout} className={styles.mobileLogoutButton}>Log Out</button>
          </>
        ) : (
          <div className={styles.mobileAuthLinks}>
